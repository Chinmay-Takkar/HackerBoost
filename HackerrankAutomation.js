...
//console.log(clargs.url+" "+clargs.config); Once check whether agrs is reading correctly or not
...
//calling the run function
 ...
 async function run()
 {
     ...
     //3.go to url
      ...
      //we got numpages now , now we need on the next page button (numPages-1) times 
   await page.waitFor(3000);
...
let curls=await page.$$eval("a.backbone.block-center",function(atags){//curls mtlb contest url
      ...
      console.log(curls); //check print url of all contests in pages
